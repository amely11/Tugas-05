        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <div class="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <div class="p-6 bg-white">
              ...
              <h4 class="text-lg text-gray-700 font-bold mt-2">$10.5</h4>
              <p class="text-gray-500 text-sm mt-2">5 types of shoos available</p>
          ...
          <div class="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <div class="p-6 bg-white">
              ...
              <h4 class="text-lg text-gray-700 font-bold mt-2">$12.5</h4>
              <p class="text-gray-500 text-sm mt-2">5 types of shoos available</p>
              <div class="flex space-x-2 mt-6">
                <svg class="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <div class="p-6 bg-white">
              ...
              <h4 class="text-lg text-gray-700 font-bold mt-2">$14.5</h4>
              <p class="text-gray-500 text-sm mt-2">5 types of shoos available</p>
              <div class="flex space-x-2 mt-6">
                <svg class="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="bg-gray-50 shadow-md overflow-hidden rounded cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <div class="p-6 bg-white">
              ...
              <h4 class="text-lg text-gray-700 font-bold mt-2">$15.5</h4>
              <p class="text-gray-500 text-sm mt-2">5 types of shoos available</p>
              <div class="flex space-x-2 mt-6">
                <svg class="w-5 fill-[#facc15]" viewBox="0 0 14 13" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
